...
import com.axis.service.EmployeeSecurityService;
...
public class JWTController {
    ...
    @PostMapping("/employee-security-login")
    public ResponseEntity<?> employeeToken(@RequestBody JWTRequest jwtRequest) throws Exception{
        ...
        UserDetails userDetails = employeeSecurityService.loadUserByUsername(jwtRequest.getUsername());
